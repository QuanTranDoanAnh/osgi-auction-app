...
public class SealedFirstPriceAuctioneerActivator implements BundleActivator {
    ...
    public void start(BundleContext bundleContext) {
        ...
        // Register service when started
        serviceRegistration = bundleContext.registerService(Auctioneer.class.getName(), auctioneer, auctioneer.getAuctionProperties());
    }

    public void stop(BundleContext context) {
        System.out.println("Stopping the bundle");
        serviceRegistration.unregister(); //Unregister service when stopped
    }
